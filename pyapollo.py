...
class ApolloClient(object):
    def __init__(self, app_id, cluster='dev', config_server_url='http://localhost:8080', timeout=60, ip=None):
    ...
    def start(self, use_eventlet=False, eventlet_monkey_patch=False, catch_signals=False):
        ...
        if use_eventlet:
            ...
            thread_pool.submit(self._listener)
            # t.start()
